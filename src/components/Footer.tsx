...
const navigation = {
  solutions: [
    { name: 'AI Agents', href: '/marketplace' },
    ...
    <footer className="bg-white dark:bg-gray-900" aria-labelledby="footer-heading">
      ...
      <div className="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8">
            <Link href="/" className="flex items-center space-x-3">
              ...
              />
              <span className="font-semibold text-xl text-gray-900 dark:text-white">AI Agents</span>
            </Link>
            <p className="text-sm leading-6 text-gray-600 dark:text-gray-400">
              Empowering businesses with intelligent AI agents for automation and growth.
            </p>
        ...
        <div className="mt-16 border-t border-gray-900/10 dark:border-gray-100/10 pt-8 sm:mt-20 lg:mt-24">
          <p className="text-xs leading-5 text-gray-500 dark:text-gray-400">&copy; 2024 AI Agents Marketplace. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
